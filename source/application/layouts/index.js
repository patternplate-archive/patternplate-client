function layout(props) {
	...
	<html>
		<head>
			...
			<link rel="icon" type="image/png" href="${props.base}/static/images/patternplate-favicon-32.png" sizes="32x32" />
			<link rel="icon" type="image/png" href="${props.base}/static/images/patternplate-favicon-16.png" sizes="16x16" />
			<link rel="stylesheet" href="${props.base}${props.stylesheet}" data-application-theme="data-application-theme">
		</head>
		<body>
